...
export const AOMTY_URL = 'https://alexfranzen.bandcamp.com/'
export const EWIPATCHES_URL = 'https://www.ewipatches.com/'
export const INSTAGRAM_URL = 'https://www.instagram.com/alex_charland_music/'
export const IMPROVING_URL = 'https://improving.com/'
export const BRAHMULUS_URL = 'https://brahmulus.bandcamp.com/album/cru'
export const FRINGE_URL = 'https://fringecharacter.bandcamp.com/album/phases'
export const RITT_URL = 'https://distrokid.com/hyperfollow/rittdeitz/hinge?fbclid=IwAR0DKgyfwEb2vLmZlRHvHztr4vCA-JdATXBPhutH6yAGVeEWTJwIK-ilQRI'
export const LEFT_FIELD_URL = 'https://leftfieldquartet.bandcamp.com/releases'
export const SHOW_YOUR_WORK_URL = 'https://austinkleon.com/show-your-work/'
