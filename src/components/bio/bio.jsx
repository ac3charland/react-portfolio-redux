        ...
        <div className={`${cb}__content-wrapper`}>
            ...
            <div className={`${cb}__flex`}>
                ...
                <div className={`${cb}__copy-wrapper`}>
                    ...
                    <p>A graduate of the <a href={BOOTCAMP_URL}>University of Minnesota Coding Bootcamp</a>, he gained professional experience in React, Redux, CSS preprocessors (LESS), accessible web design, and test-driven, agile development (including unit, integration, and visual regression testing) on a team at Best Buy. From there, he gained full-stack experience working with Redux Toolkit, Express.js, MySQL, and MikroORM at Northwestern Mutual, again following agile practices like standups, sprints, retrospectivess, and story-pointing.</p>
                    <p>Alex is also an avid freelancer, building websites and mobile applications for musicians, small businesses, and his own online store. Outside of work, he loves <a href={MUSIC_URL}>playing and writing music</a>, cooking, running, and learning new technologies through the creation of various <a href={GITHUB_PROFILE_URL}>side projects</a>.</p>
                </div>
            </div>
        </div>
    </div>
