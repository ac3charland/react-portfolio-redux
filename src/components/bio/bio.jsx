        ...
        <div className={`${cb}__content-wrapper`}>
            ...
            <div className={`${cb}__flex`}>
                ...
                <div className={`${cb}__copy-wrapper`}>
                    <p>Alex Charland is a frontend developer specializing in React, Redux, test-driven development, and accessible web design. He currently works building applications on the <a href={BEST_BUY_URL}>sixth-most-trafficked ecommerce site in the United States</a>. Driven and curious, with a love of collaboration and an eye for detail, he draws from experience in a variety of fields, including music, healthcare, and the biological sciences.</p>
                    <p>After graduating from the University of Wisconsin Madison with a Bachelor of Science, Alex originally planned to be a physician assistant. However, after feeling burned out from his premed classes, he decided to take a gap year to try something completely different&mdash;coding. After spending a year teaching himself <a href={SWIFT_URL}>Swift</a>, Alex realized he had found his true calling, and quickly enrolled in the <a href={BOOTCAMP_URL}>University of Minnesota Coding Bootcamp</a>. There, he gained a solid footing in full-stack web development, including fundamentals like HTML, CSS, and Javascript, and modern technologies like React, Node.js, and MongoDB.</p>
